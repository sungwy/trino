            ...
            extends DistributedQueryRunner.Builder<Builder>
    {
                ...
                throws Exception
        {
            ...
            try {
                ...
                if ("jdbc".equalsIgnoreCase(catalogType) && !icebergProperties.containsKey("iceberg.metastore.jdbc.default-warehouse-dir")) {
                    icebergProperties.put("iceberg.metastore.jdbc.default-warehouse-dir", dataDir.toString());
                }
